  ...
  return (
    <>
      <AppBar position="fixed">
        <Toolbar className={classes.toolbar} style={isMobile ? { } : { marginLeft: '240px' }}>
      ...
      <div>
        <nav className={classes.drawer}>
          {isMobile ? (
            ...
            <Drawer classes={{ paper: classes.drawerPaper }} variant="permanent" style={{ marginRight: '240px' }} open>
              <Sidebar setMobileOpen={setMobileOpen} />
            </Drawer>
          )}
        </nav>
